...
# Azure uses the identity-verified lastMergeSourceCommit from a fresh native PR
# read, falling back to recorded pr_head only while that source head is unknown.
