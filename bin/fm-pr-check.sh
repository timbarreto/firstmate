...
# GitHub pull request, GitLab merge request, and Gerrit change URLs are accepted,
# including merge requests and changes on self-hosted instances.
...
fm_pr_private_file_secure "$META_TMP" 600 || exit 1
