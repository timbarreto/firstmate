...
const busyEvent = (state: string, event: string) =>
  new Promise<void>((resolve) => {
    execFile("bash", ["C:/src/firstmate-perf-busy-event-helpers/bin/fm-busy-event.sh",
      "apply", "C:/src/.fm-perf-runs/busy-event-helpers/counts-final/fixture.8oizNM/pi/state", "task", state,
      "--gen", "g1789618784.673408.23550", "--source", "pi-ext", "--event", event,
    ], () => resolve());
  });
export default function (pi: any) {
  ...
  pi.on("turn_end", () => execFile("touch", ["C:/src/.fm-perf-runs/busy-event-helpers/counts-final/fixture.8oizNM/pi/state/task.turn-ended"]));
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-perf-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/counts-final/fixture.8oizNM/pi/state", "task", "--gen", "g1789618784.673408.23550",
    ]);
  });
}
