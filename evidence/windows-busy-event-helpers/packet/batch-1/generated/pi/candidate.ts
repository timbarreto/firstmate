...
export default function (pi: any) {
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-perf-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/batch-1/fixture.1aA78E/pi/state", "task", "--gen", "g1789619192.677698.12920",
    ]);
  });
}
