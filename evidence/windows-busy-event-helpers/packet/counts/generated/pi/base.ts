...
export default function (pi: any) {
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-base-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/counts/fixture.9Pim5u/pi/state", "task", "--gen", "g1789618451.669892.27287",
    ]);
  });
}
