...
const busyEvent = (state: string, event: string) =>
  new Promise<void>((resolve) => {
    execFile("bash", ["C:/src/firstmate-perf-busy-event-helpers/bin/fm-busy-event.sh",
      "apply", "C:/src/.fm-perf-runs/busy-event-helpers/smoke-1/fixture.3ixzmc/pi/state", "task", state,
      "--gen", "g1789618284.668123.2885", "--source", "pi-ext", "--event", event,
    ], () => resolve());
  });
export default function (pi: any) {
  ...
  pi.on("turn_end", () => execFile("touch", ["C:/src/.fm-perf-runs/busy-event-helpers/smoke-1/fixture.3ixzmc/pi/state/task.turn-ended"]));
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-perf-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/smoke-1/fixture.3ixzmc/pi/state", "task", "--gen", "g1789618284.668123.2885",
    ]);
  });
}
