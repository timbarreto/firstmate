...
export default function (pi: any) {
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-base-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/smoke-1/fixture.3ixzmc/pi/state", "task", "--gen", "g1789618284.668123.2885",
    ]);
  });
}
