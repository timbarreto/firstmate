...
export default function (pi: any) {
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-base-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/batch-2/fixture.BpChd1/pi/state", "task", "--gen", "g1789620547.692812.7280",
    ]);
  });
}
