...
export default function (pi: any) {
  ...
  pi.events?.on?.("codex-native:progress", () => {
    ...
    lastProgress = now;
    execFile("bash", [
      "C:/src/firstmate-base-busy-event-helpers/bin/fm-busy-event.sh", "progress", "C:/src/.fm-perf-runs/busy-event-helpers/smoke-2/fixture.EVi8Pb/pi/state", "task", "--gen", "g1789618685.672370.17300",
    ]);
  });
}
