...
The blocking and bounded-follow-up mechanisms were validated across eight harnesses on 2026-07-08 through 2026-09-21, with Claude's replacement Stop-owned path revalidated on 2026-09-21, Cursor's stop-hook park validated on 2026-08-13, Copilot's asynchronous shell-completion re-entry validated on 2026-09-01, and omp's blocking `session_stop` hook validated on 2026-09-05.
